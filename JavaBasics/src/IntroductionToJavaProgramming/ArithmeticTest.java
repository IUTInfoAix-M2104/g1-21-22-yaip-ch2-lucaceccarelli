...
public class ArithmeticTest {
	...
	public static void ArothmeticTest2() {
	      ...
	      System.out.println("The sum, difference, product, quotient and remainder of "+number1+ " and "+number2+" are "+sum+", "+difference+", "+quotient+", and"+remainder);
	...
	public static void SumProduct3Numbers() {
	      ...
	      System.out.println("The sum, difference, product, quotient and remainder of "+number1+ " and "+number2+" and "+number3+" are "+sum+", "+difference+", "+quotient+", and"+remainder);
